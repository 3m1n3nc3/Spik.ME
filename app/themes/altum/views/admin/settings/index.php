                            ...
                            <div class="<?= !in_array($this->settings->license->type, ['SPECIAL','Extended License']) ? 'container-disabled' : null ?>">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="payment_type" class="form-control form-control-lg">
                                        <option value="one_time" <?= $this->settings->payment->type == 'one_time' ? 'selected' : null ?>><?= $this->language->admin_settings->payment->type_one_time ?></option>
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="offline_payment_is_enabled" class="form-control form-control-lg">
                                        <option value="1" <?= $this->settings->offline_payment->is_enabled ? 'selected' : null ?>><?= $this->language->global->yes ?></option>
                                        <option value="0" <?= !$this->settings->offline_payment->is_enabled ? 'selected' : null ?>><?= $this->language->global->no ?></option>
                                    </select>
                                </div>
                                ...
                                <p class="h5"> 
                                    <span class="fa-sm mr-1 text-muted">
                                        <svg height="18px" width="18px" viewBox="0 0 28 28" fill="none" xmlns="http://www.w3.org/2000/svg"><g transform="scale(0.04)" clip-path="url(#clip0)" fill="currentColor"><path d="M548.416 0H31.792C14.306 0 0 14.333 0 31.852v57.333c0 17.519 14.306 31.852 31.792 31.852h515.034c17.486 0 31.792-14.333 31.792-31.852V31.852C580.208 14.333 565.901 0 548.416 0zM548.416 320.111H31.792C14.306 320.111 0 334.444 0 351.963v57.333c0 17.519 14.306 31.852 31.792 31.852h515.034c17.486 0 31.792-14.333 31.792-31.852v-57.333c1.59-17.519-12.717-31.852-30.202-31.852zM322.691 480.963H31.792C14.306 480.963 0 495.296 0 512.815v57.333C0 587.667 14.306 602 31.792 602h290.899c17.486 0 31.792-14.333 31.792-31.852v-57.333c0-17.519-14.306-31.852-31.792-31.852zM580.208 160.852H31.792C14.306 160.852 0 175.185 0 192.703v57.334c0 17.518 14.306 31.852 31.792 31.852h548.416c17.486 0 31.792-14.334 31.792-31.852v-57.334c0-17.518-14.306-31.851-31.792-31.851z"/></g><defs><clipPath id="clip0"><path fill="#fff" d="M0 0h612v602H0z"/></clipPath></defs></svg>
                                    </span> 
                                    <?= $this->language->admin_settings->payment->paystack ?>
                                </p>

                                <div class="form-group">
                                    <label><?= $this->language->admin_settings->payment->paystack_is_enabled ?></label>

                                    <select name="paystack_is_enabled" class="form-control form-control-lg">
                                        <option value="1" <?= $this->settings->paystack->is_enabled ? 'selected' : null ?>><?= $this->language->global->yes ?></option>
                                        <option value="0" <?= !$this->settings->paystack->is_enabled ? 'selected' : null ?>><?= $this->language->global->no ?></option>
                                    </select>
                                </div>

                                <div class="form-group">
                                    <label><i class="fa fa-fw fa-coins fa-sm mr-1 text-muted"></i> <?= $this->language->admin_settings->payment->paystack_currency ?></label>
                                    <input type="text" name="paystack_currency" class="form-control form-control-lg" value="<?= $this->settings->paystack->currency ?>" />
                                    <small class="text-muted"><?= $this->language->admin_settings->payment->paystack_currency_help ?></small>
                                </div>

                                <div class="form-group">
                                    <label><i class="fa fa-fw fa-coins fa-sm mr-1 text-muted"></i> <?= $this->language->admin_settings->payment->conversion_rate ?></label>
                                    <input type="text" name="payment_conversion_rate" class="form-control form-control-lg" value="<?= $this->settings->payment->conversion_rate ?>" />
                                    <small class="text-muted"><?= $this->language->admin_settings->payment->conversion_rate_help ?></small>
                                </div>

                                <div class="form-group">
                                    <label><?= $this->language->admin_settings->payment->paystack_publishable_key ?></label>
                                    <input type="text" name="paystack_publishable_key" class="form-control form-control-lg" value="<?= $this->settings->paystack->publishable_key ?>" />
                                </div>

                                <div class="form-group">
                                    <label><?= $this->language->admin_settings->payment->paystack_secret_key ?></label>
                                    <input type="text" name="paystack_secret_key" class="form-control form-control-lg" value="<?= $this->settings->paystack->secret_key ?>" />
                                </div>

                                <div class="form-group">
                                    <label><?= $this->language->admin_settings->payment->paystack_webhook_secret ?></label>
                                    <input type="text" name="paystack_webhook_secret" class="form-control form-control-lg" value="<?= $this->settings->paystack->webhook_secret ?>" />
                                </div> 
