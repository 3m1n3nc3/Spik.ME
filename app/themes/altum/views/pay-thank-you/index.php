...
<div class="container">
    ...
    <div class="d-flex flex-column align-items-center justify-content-center text-center">
        ...
        <?php if($data->package_id == 'trial'): ?>
            ...
            <p class="text-muted"><?= $this->language->pay_thank_you->package_trial_start ?></p>

        <?php elseif(is_numeric($data->package_id)): ?>

            <?php if($_GET['payment_processor'] == 'stripe'): ?>

                <p class="text-muted"><?= $this->language->pay_thank_you->package_custom_will_start ?></p>

            <?php elseif($_GET['payment_processor'] == 'paypal'): ?>

                <?php if($_GET['payment_type'] == 'one_time'): ?>
                    <p class="text-muted"><?= $this->language->pay_thank_you->package_custom_start ?></p>
            ...
            <?php elseif($_GET['payment_processor'] == 'offline_payment'): ?>
                ...
                <p class="text-muted"><?= $this->language->pay_thank_you->package_custom_pending ?></p>
...
<script>
    ...
    let package_id = current_url.searchParams.get('package_id');
