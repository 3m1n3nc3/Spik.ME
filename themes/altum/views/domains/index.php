...
<section class="container pt-5">
    ...
    <div class="d-flex justify-content-between">
        ...
        <div class="col-auto p-0">
            <?php if(($this->user->package_settings->domains_limit??0) != -1 && $data->total_domains >= ($this->user->package_settings->domains_limit??0)): ?>
    ...
    <?php else: ?>
        <div class="d-flex flex-column align-items-center justify-content-center">
            ...
            <?php if($this->user->package_settings->domains_limit != -1 && $data->total_domains < $this->user->package_settings->domains_limit): ?>
